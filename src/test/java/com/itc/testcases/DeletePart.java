...
/**
 *
 * Summary -------------- User should be able to Delete New part.
 *
 * Prerequisite : ----------------- 1. Test User Credentials - Product Manager ,
 * Design Engineer 2. Product Name 3. Part Name
 *
 * Steps: ------- 1. Login to Windchill Server 2. Navigate to Product Container
 * 3. Click on expand and navigate to "Folders" of product 4. Click on Actions
 * --> New ---->New Part 5. User fills in required details in the form and
 * clicks on "Next". (Note: All fields marked in * are mandatory fields). 6.
 * Navigate to "Folders" of product 7. Select newly created part and delete it.
 *
 * Expected Behaviour: ----------- 1.User should be able to Create new part.
 *
 * @author "*****"
 */

@Listeners(CustomListeners.class)
public class DeletePart extends BaseTest {
	HomePage home;
	BrowsePage browse;
	ProductPage product;
	...
	@Test
	@TestInfo(FunctionalArea = "Delete New Part", Owner = "rsakhare", Tags = { "QA", "Functional",
			"05-03-2025" }, TestCaseID = "", Description = "User Delete Created part in product")
	public void deletepart() {
		...
		LogUtil.info("switch to parent window");
		...
		LogUtil.info("Delete Newly Created Part");
		home.gotoBrowse();
		browse.RecentProducts();
		browse.openSpecificSectionOfProduct(productName, "Folders");
