...
* Summary
*--------------
* User should be able to Search Created Document in SerchInTable.
*
* Prerequisite :
* -----------------
...
* 4. Click  on Actions --> New ---->New Document 
* 5. User fills in required details in the form. (Note: All fields marked in * are mandatory fields).
* 8. Click Finish
* 9. Click Serch In Table
* 10. Enter Created Document Name
* 11. Click Serch In Table Icon
* 
* Expected Behaviour:
* -----------
* 1.User should be able to Validate SerchInTable Create WTDocument Successfully.
*
* @author "***"
*/
...
public class SearchDocument extends BaseTest {
	HomePage home;
	BrowsePage browse;
	ProductPage product;
	String docName;
	...
	@Test
    @TestInfo(FunctionalArea = "Search Document in SerchInTable",
        Owner = "rsakhare",
        Tags = { "QA", "Functional", "05-03-2025" },
        TestCaseID = "",
        Description = "User should be able to Search Created Document in SerchInTable")
	public void verifySearchDocument() {
			...
			LogUtil.info("Click on Actions --> New ---->New Document");
	        ...
	        product.searchObject(docName);

			LogUtil.info("Verify Documents is created");
			newDocument.validateDocumentIsPresent(docName);
	}
	...
	public void tearDown() {
		...
		browse.openSpecificSectionOfProduct(productName, "Folders");
		product.folderContentsDropdown(folderDropdownText);
		product.SelectObjectCheckbox(docName);
		product.gotoActions();
