...
/**
 *
 * Summary -------------- User should be able to Delete BOM redline.
 *
 * Prerequisite : ----------------- 
 ...
 *  10. Selectaffected object(Part). 
 *  11. Click on action. 
 *  12. Create on Create BOM redline.
 *  13. Delete BOM Redline
 *
 * Expected Behaviour: ----------- 1.User should be able to delete BOM Redline
 *
 * @author "*****"
 */
@Listeners(CustomListeners.class)
public class DeleteBOMRedline extends BaseTest {
	HomePage home;
	BrowsePage browse;
	ProductPage product;
	...
	@Test
    @TestInfo(FunctionalArea = "User delets BOM Redline",
        Owner = "slandge",
        Tags = { "QA", "Functional", "05-03-2025" },
        TestCaseID = "",
        Description = "Delete BOM Redline")
	public void deleteBOMRedline() {
			...
			LogUtil.info("Delete BOM redline  ");
			BOMPage.deleteBOMRedline();
